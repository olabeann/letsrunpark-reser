...
const files = [
  ...
  'tokens.css', 'components.css', 'styles.css', 'admin.css', 'admin-reference.css', 'empty-states.css', 'empty-state-icons.css', 'empty-states.html', 'empty-states.js', 'error.css', '.nojekyll',
  'assets/logo/cowboy-malma.png', 'assets/logo/logo_color.svg',
  'assets/icons/discount-proof-alert.svg',
  'assets/icons/empty-ticket.svg', 'assets/icons/empty-cart.svg', 'assets/icons/empty-search.svg', 'assets/icons/empty-reservation.svg',
  'assets/icons/empty-program.svg', 'assets/icons/empty-session.svg', 'assets/icons/empty-settlement.svg', 'assets/icons/empty-account.svg',
