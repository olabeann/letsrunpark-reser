    ...
    frontend: {
      ...
      groups: [
        ...
        { title: "운영 관리자 화면", eyebrow: "ADMIN FLOW", items: [
          ...
          ["운영일 · 휴장일", "지역과 전체/개별 프로그램을 선택하거나 휴장일 등록", "캘린더에는 프로그램에 등록된 운영일만 표시하고 회차는 노출하지 않습니다. 전체 프로그램 휴장은 개별 프로그램 운영보다 우선하며 같은 날짜의 중복 휴장 등록은 막습니다. 날짜 배지는 운영(파란색, 그날 운영하는 프로그램이 모두 정상 판매 중)·일부 휴장(주황색, 프로그램 전체 또는 회차 단위 휴장이 하나라도 있지만 그날 전체가 닫히지는 않음)·휴장(빨간색, 전체 휴장이거나 그날 운영 대상 프로그램이 모두 휴장) 3가지로만 구분하며 회차별 세부 조합은 별도 배지로 나누지 않습니다.", "휴장 적용 전 날짜·지역·프로그램·회차 범위와 유효 예약 건수·인원을 확인창에 표시하고 최종 확인 후 적용합니다. 휴장 해제 시 원래 운영 일정에 포함되는 날짜만 다시 운영으로 표시합니다.", "이미 예약이 있는 날짜는 휴장 저장만으로 자동 환불하지 않습니다. 대상 예약 수와 별도 운영 취소 절차를 안내합니다."],
