(function () {
  ...
  function topicsFor(context) {
    ...
    if (context === "account") return withService([
      ...
      { key: "ACC-02", title: "지역 계정 발급 · 재설정", summary: "지역당 운영 계정 1개와 임시 비밀번호 처리", fe: [account[1]], be: [adminApi[5], adminApi[6]] },
      { key: "ACC-03", title: "지역별 접근 권한", summary: "자기 지역 CRUD·타 지역 Read의 화면 및 API 접근 제어", fe: [account[2]], be: [adminApi[0], adminApi[6]] },
