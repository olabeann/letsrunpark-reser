(function () {
  ...
  servicePolicy["ADM-01"][1] = ["예약번호 체계 · 개발 검토 반영", "예약 목록·상세와 통합예약목록 CSV에 예약번호를 표시할 때", "하나의 예약 아래 여러 티켓을 관리할 수 있다는 개발 의견을 반영해 기존 상품 구분용 -1, -2 접미사만 제거합니다. 예약번호는 LRP-YYMMDD-NNNNN 형식으로 결제 단위 하나를 사용합니다.", "예약 목록은 상품·회차별 티켓 행을 나누어 보여줄 수 있지만 각 행에는 같은 예약번호를 표시합니다. 예: 기존 LRP-260909-00001-1·-2 대신 모두 LRP-260909-00001을 표시합니다.", "상품·회차와 취소 대상은 티켓 정보로 구분하며 인원별 티켓 번호와 PG 거래번호는 예약번호와 별도로 관리합니다."];
